...
## Project 3 : Style transfer for Duckietown
...
## Project 5 : Using music transformer to generate music and then make generative model GAN react to the music (Audio-reactive Latent Interpolations with StyleGAN)
...
## ## Project 6 : Depth Map Generation with Stable Diffusion (Houdini Integration)
